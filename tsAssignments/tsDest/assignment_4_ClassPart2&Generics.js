"use strict";
// Assignment 4 
// Class Part 2 & Generics from 32 - 38
//4.1
// Do Not Edit
...
// function showTypes<S=string,N=number,B=boolean>(name? : S, num?:N , bol? : B){
//     return `${name || "Nothing"} - ${num || "Nothing"} - ${bol || "Nothing"}`
// }
// // Do Not Edit Here
...
//     getDiscount(data : T){
//         console.log(`The Discount is ${+data}`);
//     }
// }
// // Do Not Edit Here
